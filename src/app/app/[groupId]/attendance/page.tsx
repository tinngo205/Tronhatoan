...
export default async function AttendancePage({ params }: AttendancePageProps) {
  ...
  // 4. Fetch rolling 1-year attendance window to allow fast calendar switching
  const now = new Date();
  ...
  const attendance = await attendanceRepo.getGroupAttendance(groupId, startDateStr, endDateStr);
